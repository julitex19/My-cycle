...
function Foottop() {
  return (
    <div className="border-2 lg:h-60 bg-white absolute lg:-top-56 -top-52 shadow-sm rounded-2xl lg:left-40 lg:right-40 right-10 left-10 flex  items-center  flex-col-reverse lg:flex-row p-2 xl:flex-row">
